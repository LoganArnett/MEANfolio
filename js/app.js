...
.controller('MainCtrl', function () {
  var self = this;
  self.slides = [
  {image: 'images/activ8.png', description: 'Image00', url: "http://activ8.fitness/crosstrackapp/", caption: 'Fitness Tracking Web App built with AngularJS and Firebase as a final project at The Iron Yard'},
  {image: 'images/wildenglish.png', description: 'Image01', url: "http://http://loganarnett.com/wildenglish/app/#/main", caption: 'Wild English Band homepage with Soundcloud and Google Calendar integrations'},
